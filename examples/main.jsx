...
class SketchFieldDemo extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      originX: 'left',
      originY: 'top',
      imageUrl: 'https://cdn.overview.ai/automated_camera_image/ip-cam-office/1614182400139.jpg?AWSAccessKeyId=AKIAXHDQPAC7CWAMX3MP&Signature=gaYyFKJqhKfbfT0y4TVnsSKILoc%3D&Expires=1650000001',
      expandTools: false,
                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <TextField
                        ...
                        <MenuItem value={Tools.CustomPan} key="custom-pan">Custom Pan</MenuItem>
